<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'  => __( 'Header', 'trunghien' ),
        'id'     => 'basic',
        'desc'   => __( 'All of settings for header on this theme', 'trunghien' ),
        'icon'   => '',
        'fields' => array(
            array(
                'id'       => 'logo-on',
                'type'     => 'switch',
                'title'    => __( 'Enable Image Logo', 'trunghien' ),
                'desc'     => __( 'Do you want to enable image logo?', 'trunghien' ),
                'on'        => __('Enabled', 'trunghien'),
                'off'       => __('Disable', 'trunghien'),
                'hint'     => array(
            ...
            array(
                'id' => 'logo-image',
                'type' => 'media',
                'title' => __('Logo Image', 'trunghien'),
                'desc' => __('Image that you want to use as logo', 'trunghien')
            )
        )
    ) );
